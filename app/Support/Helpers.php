...
if(! function_exists('mobile_no_prefix')) {

    function mobile_no_prefix($mobile_no_prefix)
    {        
        $len =  strlen($mobile_no_prefix);

        if($len > 10){
            $mobile_no_prefix = substr($mobile_no_prefix,2);
        }

        return $mobile_no_prefix;
    }
}
