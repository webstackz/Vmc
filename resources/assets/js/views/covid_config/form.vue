...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/covid_config/create`,
            'edit': `/api/covid_config/${to.params.id}/edit`,
            'clone': `/api/covid_config/${to.params.id}/edit?mode=clone`,
    ...
    export default {
        ...
        data () {
            return {
                ...
                store: '/api/covid_config',
                method: 'POST',
                title: 'Add',
                message: 'You have successfully done!',
